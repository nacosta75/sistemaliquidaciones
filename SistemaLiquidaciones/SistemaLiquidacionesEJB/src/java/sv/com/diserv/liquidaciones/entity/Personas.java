...
@NamedQueries({
    ...
    @NamedQuery(name = "Personas.findAllByTipoSuc", query = "SELECT p FROM Personas p WHERE p.idtipopersona.idtipopersona = :idtipopersona AND p.idsucursal.idsucursal = :idsucursal")})
